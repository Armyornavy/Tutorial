...
root.bg='#ffffff'
root.title('Yahtzee')
input.geometry('1000x600+400+20')
#===== Load Images =====#
...
select6=PhotoImage(file='images/5y.gif')
...
#==== Functions =====#
def roll_all():
    button1.config(image= All[random.randrange(0,5)])
    button2.config(image= All[random.randrange(0,5)])
    button3.config(image= All[random.randrange(0,5)])
    button4.config(image= All[random.randrange(0,5)])
    button5.config(image= All[random.randrange(0,5)])
def select(x):
    if x==1:
       if no1==0:
          if orignal_1==1:
          ...
          if orignal_1==2:
              button1.config(image=select2,command=lambda:select(1))
          if orignal_1==3:
              button1.config(image=select3,command=lambda:select(1))
          if orignal_1==4:
              button1.config(image=select4,command=lambda:select(1))
          if orignal_1==5:
              button1.config(image=select5,command=lambda:select(1))
          if orignal_1==6:
              button1.config(image=select6,command=lambda:select(1))
  else:
    pass
      if x==2:
...
if button1== Button(image=roll_6,command=lambda:select(1)):
    orignal_1=6
button1.Button(image=ALL[random.randrange(0,5)],command=lamdba:select(1))
button1.grid(row=1,column=1)
button2=Button(image=All[random.randrange(0,5)],command=lambda:select(2))
button2.grid(row=1,column=2)
button3=Button(image=All[random.randrange(0,5)],command=lambda:select(3))
button3.grid(row=1,column=3)
button4=Button(image=All[random.randrange(0,5)],command=lambda:select(4))
button4.grid(row=1,column=4)
button5=Button(image=All[random.randrange(0,5)],command=lambda:select(5))
button5.grid(row=1,column=5)
reroll=Button(text='reroll',command=roll_all)
reroll.grid(row=3,column=3)
root.mainloop()
